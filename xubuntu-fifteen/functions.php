...
function xubuntu_styles( ) {
	...
	// Extra stylesheets from static.xubuntu.org
	wp_enqueue_style( 'xubuntu-style-extras', 'http://static.xubuntu.org/www/extras.css', array( 'xubuntu-style', 'xubuntu-style-common' ) );
}
